...
```bash
npx --yes github:zhaoryder/releaseguard check owner/repo
```
...
I’m looking for real ugly Release examples to turn into regression fixtures: https://github.com/zhaoryder/releaseguard
